...
namespace ShippingControl_v8.Platforms.Android.Resources
{
    /// <summary>
    /// This class is needed because Android .net-7.0 doesn't allow a direct connection with the APTIV database
    /// </summary>
